...
protected:
  ...
  void prepareSettingsOfTile(MeshTile *tile, GDALDataset *dataset, const TileCoordinate &coord, float *rasterHeights, std::vector<float *> &rasterExtensions, ctb::i_tile tileSizeX, ctb::i_tile tileSizeY) const;
};
